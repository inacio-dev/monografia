...
class BMI160Manager:
    ...
    def __init__(
        self,
        sample_rate=100,
        accel_range=None,  # Default da classe: ACCEL_RANGE_4G (main.py sobrescreve para 2G)
        gyro_range=None,  # Default da classe: GYRO_RANGE_500 (main.py sobrescreve para 250)
        i2c_address=None,  # Default da classe: I2C_ADDRESS_LOW
